...
public class ListConversion {
	...
	public ListConversion() { // Constructor for iteration
	...
	public static void main(String[] args) {
		ListConversion li = new ListConversion(); // obj to access mylist in main
		System.out.println(
		...
		System.out.println(
				"---Conversion with functionl interface----");
